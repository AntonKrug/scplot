...
var sourceDirFlag = flag.String("source", "", "source directory where the binary files will be fetch from (when the source_current_folder is set true then by default it's the current working directory)")
